...
let 论述 = [ 
    "现在，在公司已经过了许久，所以我们要认清一个事实， ",
    "我们不得不面对一个非常尴尬的事实，那就是从学生到职场的转变是非常困难的， ",
    "学会做人，学会做事。 ",
    "think twice，code once",
    "互联网公司的需要我们学习的非常多",
    "主题，经过这么久的时间，我们必须认清一个事实，那就是学会在实践中成长。",
    "所谓成长，我们就要学会各种规章制度，学会在有限的条件上绽放无限的可能",
    "我们一般认为，有了需求就有成长，但做需求的过程中的思考才是最可贵的。 ",
    "问题的关键究竟为何? ",
    "问题是因为什么才会出现？",
    "每个人都不得不面对这些问题。  在面对这种问题时， ",
    "一般来讲，我们都必须务必慎重的考虑怎么样的代码才会产生线上的问题。 ",
    "要想清楚，程序员，到底是一种怎么样的存在。 ",
    "了解清楚计算机的语言到底是一种怎么样的存在，是解决一切问题的关键。 ",
    "就我个人来说，云智对我的意义，不能不说非常重大。 ",
    "本人也是经过了深思熟虑，在每个日日夜夜思考这个问题。 ",
    "感谢领导和同事对我的帮助。 ",
    "再次感谢各位大家对我的指导。 ",
    "生活中，我也会记住leader和导师对我的淳淳教导。 ",
    "这种事实对本人来说意义重大，相信对这个世界也是有一定意义的。 ",
    "我们知道，既然成为了职场人，就要担负责任。 ",
    "既然如此， ",
    "那么， ",
    "我认为， ",
    "一般来说， ",
